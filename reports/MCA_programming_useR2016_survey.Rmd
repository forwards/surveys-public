...
plot(res.mca, invisible = c("ind", "quali.sup"), cex = 0.7, selectMod = "coord 15")
```
...
plot(res.mca, invisible = c("ind"), cex = 0.7, selectMod = "cos2 12", xlim = c(-2,4))
...
tmp[,-4] <- as.character(sprintf("%#.2f", tmp[,-4]))
tmp[,4] <- p
kable(tmp[tmp[, "v.test"]>3, 1:4], digits = 2, align = "rrrr")
```
